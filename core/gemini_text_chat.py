...
_GEMINI_PRIORITY_TOOLS = [
    "ask_user", "fabrica", "procedimientos", "auto_fabrica", "mcp_bridge", "pro_contexto", "prompt_ab", "edit_journal", "token_saver", "world_model", "auto_mejora", "sesiones", "ab_automated", "informe_semanal", "memoria", "system_monitor", "window_manager", "weather_report", "screen_vision",
