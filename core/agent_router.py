...
AGENT_DEFINITIONS = {
    ...
    # ── 11. GUARDIAN — SAMX: autocuidado continuo de ERIS ──
    "guardian": {
        "name": "GuardianaAgent",
    ...
    # ── 12. MENTORA — maestro / superaprendizaje de ERIS ──
    "mentora": {
        "name": "MentoraAgent",
        ...
        "keywords": [
            ...
            "explorá libre", "explora libre", "explorá", "explora",
            "aprendé algo nuevo", "aprende algo nuevo", "explorá en internet",
            "importá esta página", "importa esta página", "importá la página",
            "tu fuente", "tus fuentes", "mis fuentes", "las fuentes",
            "muestrame las fuentes", "mostrame las fuentes", "de dónde aprendés",
            "aprendé de esta web", "aprende de esta web",
            "aprendé de esta página", "aprende de esta página", "ingestá", "ingesta",
            "aprendé de la web", "aprende de la web", "aprendé de las fuentes",
            "aprende de las fuentes", "navegá libre", "navega libre",
        ],
        "penalty_keywords": [
            "spotify", "musica", "youtube", "email", "calendario", "navegador",
