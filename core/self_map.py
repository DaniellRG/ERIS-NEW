...
ERIS_MAP = {
    ...
    "core": {
        ...
        "offline_voice.py": {"desc": "Pipeline offline — Vosk STT + cerebro dual + SAPI/Edge/Kokoro TTS (100% offline) + push-to-talk", "recently_created": True},
        "hud_terminal.py": {"desc": "HUD estilo terminal (Jarvis OS) — vitales sistema, agenda, audio, comandos (tool 'hud_terminal')", "recently_created": True},
        "self_healing.py": {"desc": "Auto-healing, auto-learning, health check cada 5 min, syntax fix, error log", "recently_created": True},
        "rag_engine.py": {"desc": "RAG — embeddings semánticos sobre vault Obsidian, búsqueda por significado (tool 'rag_engine')", "recently_created": True},
        "voice_cloning.py": {"desc": "Clonación de voz local XTTS v2 — clone, speak con voz referencial (tool 'voice_cloning')", "recently_created": True},
        "updater.py": {"desc": "Auto-update Eris — check, changelog, apply (tool 'eris_updater')", "recently_created": True},
        "memory_consolidator.py": {"desc": "Consolidación memoria — resumir, podar, backup (tool 'memory_consolidator')", "recently_created": True},
        "voice_translator.py": {"desc": "Traducción + voz — traducir y hablar en otro idioma (tool 'voice_translator')", "recently_created": True},
        "workflow_engine.py": {"desc": "Workflow/skill chaining — crear, ejecutar flujos multi-paso (tool 'workflow_engine')", "recently_created": True},
        "auto_healer.py": {"desc": "Auto-healing profundo — traceback parser, fix imports, error journal (tool 'auto_healer')", "recently_created": True},
        "proactive_monitor.py": {"desc": "Monitor proactivo background — vault, CPU, Ollama, logs (tool 'proactive_monitor')", "recently_created": True},
        "multi_ai_hub.py": {"desc": "Hub multi-AI — routing inteligente Ollama/OpenRouter/OpenAI/Anthropic (tool 'multi_ai_hub')", "recently_created": True},
        "knowledge_graph.py": {"desc": "Grafo conocimiento Obsidian — relaciones, clústers, visualización (tool 'knowledge_graph')", "recently_created": True},
        "test_generator.py": {"desc": "Generador tests AST — pytest automático, coverage, sugerencias (tool 'test_generator')", "recently_created": True},
    },
    ...
    "actions": {
        ...
        "obsidian_brain.py": {"desc": "Segundo cerebro — leer/escribir/buscar/link notas Obsidian, wiki indexada con resúmenes + backlinks (tool 'obsidian_note')"},
        ...
        "phone_control.py": {"desc": "CONTROL DEL CELULAR — via adb/scrcpy: espejar pantalla en PC, abrir apps, tocar/deslizar/escribir, screenshot, batería", "recently_created": True},
        ...
        "rutinas_diarias.py": {"desc": "Rutinas diarias (Jarvis OS) — inbox, plan, métricas, vault Obsidian, cierre (tool 'rutinas_diarias')", "recently_created": True},
        "web_search.py": {"desc": "Búsqueda web real-time DuckDuckGo — search, news, images (tool 'web_search')", "recently_created": True},
        "browser_auto.py": {"desc": "Automatización navegador Playwright — open, scrape, click, type, screenshot (tool 'browser_auto')", "recently_created": True},
        "email_manager.py": {"desc": "Email IMAP/SMTP — leer, enviar, buscar, folders (tool 'email_manager')", "recently_created": True},
        "google_calendar.py": {"desc": "Google Calendar API real — eventos, crear, eliminar (tool 'google_calendar')", "recently_created": True},
        "task_manager.py": {"desc": "Gestor tareas Kanban — dependencias, deadlines, prioridades (tool 'task_manager')", "recently_created": True},
        "home_assistant.py": {"desc": "Domótica Home Assistant — luces, switches, clima, media (tool 'home_assistant')", "recently_created": True},
        "screen_context.py": {"desc": "Captura pantalla + OCR + descripción visual (tool 'screen_context')", "recently_created": True},
        "code_sandbox.py": {"desc": "Sandbox Python — ejecutar código en tiempo real con seguridad (tool 'code_sandbox')", "recently_created": True},
        "translator.py": {"desc": "Traducción automática 100+ idiomas deep-translator (tool 'translator')", "recently_created": True},
        "pdf_generator.py": {"desc": "Generación PDF desde markdown/texto con fpdf2 (tool 'pdf_generator')", "recently_created": True},
        "rss_reader.py": {"desc": "Lector RSS/Atom feeds, suscripciones, alertas (tool 'rss_reader')", "recently_created": True},
        "vault_passwords.py": {"desc": "Vault contraseñas encriptado Fernet+PBKDF2 (tool 'vault_passwords')", "recently_created": True},
        "ssh_remote.py": {"desc": "SSH remoto con paramiko — exec, upload, download (tool 'ssh_remote')", "recently_created": True},
        "git_smart.py": {"desc": "Git inteligente — auto-commit messages descriptivos (tool 'git_smart')", "recently_created": True},
        "sql_manager.py": {"desc": "Gestor SQL — SQLite + PostgreSQL, queries, export (tool 'sql_manager')", "recently_created": True},
        "spotify_control.py": {"desc": "Control Spotify — play/pause/search/playlist (tool 'spotify_control')", "recently_created": True},
        "habit_tracker.py": {"desc": "Hábit tracker — streaks, stats, recordatorios (tool 'habit_tracker')", "recently_created": True},
        "chart_generator.py": {"desc": "Generador gráficos matplotlib — bar/line/pie/scatter (tool 'chart_generator')", "recently_created": True},
        "image_generator.py": {"desc": "Generador imágenes — Pollinations.ai + SD API (tool 'image_generator')", "recently_created": True},
        "clipboard_history.py": {"desc": "Historial clipboard — pin snippets, categorías, búsqueda (tool 'clipboard_history')", "recently_created": True},
        "finance_tracker.py": {"desc": "Finanzas personales — CSV bancario, categorías, presupuestos (tool 'finance_tracker')", "recently_created": True},
        "file_organizer.py": {"desc": "Organizador archivos — reglas, duplicados, undo (tool 'file_organizer')", "recently_created": True},
    },
