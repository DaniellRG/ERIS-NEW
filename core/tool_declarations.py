...
"name": "pentest_lab",
        ...
        "parameters": {"type": "OBJECT", "properties": {
            ...
            "vector": {"type": "STRING", "description": "Vector de exploit para action=exploit: vsftpd_234_backdoor (CVE-2011-2523, shell root real) · usermap_script (CVE-2007-2447, RCE root via Samba/impacket) · ms08_067 (detección/documentación)"},
