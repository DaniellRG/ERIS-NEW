...
"name": "pentest_lab",
        ...
        "parameters": {"type": "OBJECT", "properties": {
            ...
            "target": {"type": "STRING", "description": "IP objetivo (para scan/vuln/exploit/brute/sniff)"},
            "vector": {"type": "STRING", "description": "Vector de exploit para action=exploit: vsftpd_234_backdoor (CVE-2011-2523, shell root real) o ms08_067 (detección/documentación)"},
            "command": {"type": "STRING", "description": "Comando a ejecutar en la shell comprometida (default whoami; opciones: whoami, identidad, escaneo)"},
