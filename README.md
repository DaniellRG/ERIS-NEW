...
inteligencia emocional, NeuroSpheres, auto-evolución y **496 tools**. Corre en
...
├── core/                    # Motor interno
│   ├── tool_registry.py         # 496 tools (callables)
...
- Estado del repo: **496 tools sincronizadas (459=459, 0 duplicados)**, 12
