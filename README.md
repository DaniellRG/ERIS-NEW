...
inteligencia emocional, NeuroSpheres, auto-evolución y **475 tools**. Corre en
...
├── core/                    # Motor interno
│   ├── tool_registry.py         # 475 tools (callables)
...
- Estado del repo: **475 tools sincronizadas (459=459, 0 duplicados)**, 12
