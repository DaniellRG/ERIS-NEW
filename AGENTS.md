...
| `core/tool_registry.py` | 448 tool callables |
| `core/tool_declarations.py` | 448 LLM-facing declarations (0 dupes, sync con registry) |
...
`test_all.py` verifies: tool registry (448), declarations (448), sync, no duplicates, core modules, agents, NeuroSpheres, CLI, action imports, data files, knowledge, Python env, compile check, BOM check, GUI window.
