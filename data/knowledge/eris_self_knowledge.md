...
- tool_declarations.py: **459 schemas de herramientas** para Gemini Function Calling (subconjunto priorizado <=120 por request)
- tool_dispatcher.py: Despachador que ejecuta tool calls via ThreadPoolExecutor
- tool_registry.py: Registro lazy-loading de **459 tools**, imports bajo demanda
...
| core/tool_declarations.py | 459 schemas de herramientas para Gemini (subconjunto <=120 por request) |
| core/tool_dispatcher.py | Despachador que ejecuta mis tools |
| core/tool_registry.py | Registro lazy-loading de 459 tools |
