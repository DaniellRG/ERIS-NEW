...
function showToast(msg) {
    ...
    t.textContent = msg;
    t.style.cssText = 'position:fixed;bottom:2rem;right:2rem;background:#f97316;color:white;padding:1rem 2rem;border-radius:16px;z-index:9999;transform:translateY(100px);opacity:0;transition:all 0.4s ease;';
...
<script>
(function(){const colors=['#f97316','#dc2626','#fbbf24'];const shapes=document.getElementById('shapes3d');
