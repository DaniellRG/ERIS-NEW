...
function showToast(msg) {
    ...
    t.textContent = msg;
    t.style.cssText = 'position:fixed;bottom:2rem;right:2rem;background:#f43f5e;color:white;padding:1rem 2rem;border-radius:16px;z-index:9999;transform:translateY(100px);opacity:0;transition:all 0.4s ease;';
...
const mat=new THREE.PointsMaterial({color:'#f43f5e',size:0.3,transparent:true,opacity:0.6});
