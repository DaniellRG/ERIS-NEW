"""
send_message.py — Envío de mensajes para ERIS.
...
def _open_app(app_name: str) -> bool:
    ...
    try:
        ...
        safe_print(f"[SendMessage] ⚠️ No se pudo abrir {app_name}: {e}")
        return False
...
def _bc(params: dict, player=None) -> str:
    """Wrapper: fuerza Chrome Playwright (ERIS profile) para todas las acciones de WhatsApp."""
