...
def whatsapp(parameters: dict, player=None) -> str:
    ...
    if action == "add_contact":
        ...
        if contact_name.lower() in contacts:
            ...
            save_contacts(contacts)
            return f"Contacto '{contact_name}' eliminado de la base de datos de ERIS."
        return f"No se encontró ningún contacto con el nombre '{contact_name}'."

    elif action == "list_contacts":
        if not contacts:
            return "No tienes contactos guardados en la base de datos de ERIS todavía."
        res = "Contactos guardados en ERIS:\n"
